...
namespace MorcuTool
{
    public class Compression
    {
        ...
        {
            byte[] res;
            bool smaller = DBPFCompression.Compress(filebytes, out res);
    ...
    **/
    ...
    namespace Tiger
    {
        class DBPFCompression
        {
            ...
            {
                var compressor = new DBPFCompression(5);
            ...
            {
                var compressor = new DBPFCompression(level);
                compressed = compressor.Compress(data);
                return (compressed != null);
            }
