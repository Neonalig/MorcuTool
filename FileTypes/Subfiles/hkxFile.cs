...
public class hkxFile
{
    ...
    public readonly hkxClassTable classTable;
    public readonly hkxDataSection dataSection;

    public readonly List<havokObject> havokObjects = new();
    ...
    public class hkxClassTable {
        ...
        public readonly int endOfClassTableOffset;
        public int val2;
        public int val3;
        public int val4;
        public int val5;
        ...
        public readonly List<hkxClassTableEntry> entries = new();
        ...
        public hkxClassTable(Subfile basis, int offset)
        {
            ...
            {
                var newEntry = new hkxClassTableEntry(this, basis, pos);
        ...
        public class hkxClassTableEntry
        {
            ...
            public byte unk;
            public readonly int offset; //this offset goes to the beginning of the name, it's what the virtual fixup table talks to
    ...
    public class hkxDataSection
    {
        ...
        public string name = "";
        public readonly int sectionOffset;
        public readonly int localFixupTableOffset; //relative to sectionOffset
        public readonly int globalFixupTableOffset; //relative to sectionOffset
        public readonly int virtualFixupTableOffset; //relative to sectionOffset
        public readonly int val4;
        public int val5;
        public int val6;

        public readonly List<hkxLocalFixupEntry> localFixupTable = new();
        public readonly List<hkxVirtualFixupEntry> virtualFixupTable = new();
        ...
        {
            public readonly int objectOffset; //offset to the object from the beginning of the data section
            public readonly int classOffset;  //offset to the type of object in the class table
        ...
        {
            public readonly int destOffset; 
    ...
    public hkxFile (Subfile basis) {
        ...
        File.WriteAllLines($"{basis.filename}.obj", obj.ToArray());
    }
        ...
        for (int i = 0; i < classTable.entries.Count; i++) {
            ...
            if (classTable.entries[i].offset == entry.classOffset) {
                ...
                switch (target.name) {
                    ...
                    case "hkBoxShape":
                        var newBoxShape = new hkBoxShape(basis, dataSection.sectionOffset + entry.objectOffset);
                        havokObjects.Add(newBoxShape);
                        break;
                    case "hkSimpleMeshShape":
                        var newSimpleMeshShape = new hkSimpleMeshShape(basis, dataSection.sectionOffset + entry.objectOffset);
    ...
    public int getLocalFixUpOffset(int offset) {
        ...
        MessageBox.Show($"Warning: failed to find offset {offset} in the local fixup table");
        return -1;
    }
}