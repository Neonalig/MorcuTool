...
public class MaterialData
{
    ...
    public class Param {
        public readonly MaterialParameter paramType;
        public int unk;
        ...
        foreach (Param parameter in parameters) {
            ...
            switch (parameter.paramType) {
                case MaterialParameter.diffuseMap:
                    ...
                    if (useBigEndian)
                    {
                        hash_of_diffuse_texture = Utility.ReadUInt32BigEndian(basis.filebytes, pos); pos += 4;
                        ...
                        hash_of_diffuse_texture = BitConverter.ToUInt32(basis.filebytes, pos); pos += 4;
                    ...
                    parameter.diffuse_texture = AppState.activePackage.FindFileByHashAndTypeID(hash_of_diffuse_texture,typeID_of_diffuse_texture);
                    break;
                default:
